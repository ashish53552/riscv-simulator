...
def handle_branches(PC, control_signals, instruction_dict, values, branch_prediction):
...
def pipeline_decode(info) :
	...
	instruction, PC, branch_prediction = info
    ...
    # I format
        ...
        if funct3 == '000': # jalr
          ...
          return handle_branches(PC, control_signals, instruction_dict, None, branch_prediction)
    ...
    # SB format
        ...
        if funct3 == '000': # beq
          control_signals['mux_alu'] = 'register_&_register'
        	...
        	return handle_branches(PC, control_signals, instruction_dict, values, branch_prediction)
